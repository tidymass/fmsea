...
#' @param mz mz
#' @param rt rt
#' @param peak.mz peak.mz
#' @param peak.rt peak.rt
#' @param rt.tol rt.tol
#' @param max.isotope max.isotope
#' @export

annotate_isotope = function(formula = "C9H14N2O12P2",
                            adduct = "M-H",
                            charge = 1,
                            mz = 402.9998,
                            rt = 823.1462,
                            ...
                            mz.tol = 15,
                            max.isotope = 4) {
  formula1 <- tinyTools::sum_formula(formula = formula,
                                     adduct = adduct)
